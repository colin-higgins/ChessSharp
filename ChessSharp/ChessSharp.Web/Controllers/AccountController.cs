...
namespace ChessSharp.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public UserManager<ChessUser> UserManager { get; private set; }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ChessUser() { UserName = model.UserName };
        ...
        private async Task SignInAsync(ChessUser user, bool isPersistent)
        {
