<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="whiteChessBoard.ascx.cs" Inherits="ChessSharp.whiteChessBoard" %>

<script type="text/javascript" src="~/Scripts/colorboard.js"></script>

<asp:Panel ID="boardPanel" runat="server">
        <asp:Table ID="whiteChessTable" CssClass="chess" runat="server">
        ...
        <script type="text/javascript">displayboard()</script>
